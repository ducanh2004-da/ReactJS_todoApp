...
export default function TaskForm({ editId = null, open = false, onClose, rows = [], onTaskChange }) {
  ...
  // GraphQL mutations
  const ADD_TASK = gql`
    mutation AddTask($title: String!, $description: String!, $dueAt: DateTime!, $userId: Float!, $status: TaskStatus) {
      addTask(userId: $userId, data: { title: $title, dueAt: $dueAt, description: $description, status: $status, tags: ["học bài2"] }) {
        message
        data {
          id
          title
  ...
  const EDIT_TASK = gql`
    mutation EditTask($id: Float!, $title: String!, $description: String!, $dueAt: DateTime!, $status: TaskStatus) {
      editTask(id: $id, data: { title: $title, description: $description, dueAt: $dueAt, status: $status }) {
        message
        data {
          id
          title
